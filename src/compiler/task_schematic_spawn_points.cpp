...
#include "database/model/SchematicSpawnPointsStage.hxx"
...
public:
    ...
    {
        const mega::io::CompilationFilePath schematicSpawnPointsCompilationFile
        ...
        if( m_environment.restore( schematicSpawnPointsCompilationFile, determinant ) )
        {
            m_environment.setBuildHashCode( schematicSpawnPointsCompilationFile );
            cached( taskProgress );
            return;
        }
        ...
        m_environment.temp_to_real( schematicSpawnPointsCompilationFile );
        m_environment.stash( schematicSpawnPointsCompilationFile, determinant );
