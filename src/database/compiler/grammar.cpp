    ...
    namespace schema
    {
        ...
        inline ParseResult parse_impl( const std::string& strInput, ResultType& result, std::ostream& errorStream )
        {
            GrammarType< IteratorType > grammar;
            {
                ...
                boost::spirit::qi::on_error< boost::spirit::qi::fail >(
                    grammar.m_main_rule,
                    error_handler( boost::spirit::qi::_1, boost::spirit::qi::_2, boost::spirit::qi::_3, boost::spirit::qi::_4 ) );
            }
        ...
        public:
                ...
                : IdentifierGrammar::base_type( m_main_rule, "identifier" )
            {
                ...
                using namespace boost::phoenix;
                m_main_rule
                    = lexeme[ char_( "a-zA-Z" )[ push_back( _val, qi::_1 ) ] >> *( char_( "a-zA-Z0-9_" )[ push_back( _val, qi::_1 ) ] ) ];
            }
    ...
    namespace schema
    {
        ...
        public:
                ...
                : StageGrammar::base_type( m_main_rule, "Stage" )
            {
                ...
                m_per_source_accessor_rule = lit( "persource" ) >> lit( "accessor" ) >> m_grammar_type[ at_c< 0 >( _val ) = qi::_1 ];
...
std::ostream& operator<<( std::ostream& os, const db::schema::Stage& stage )
{
    ...
    struct StageElementPrinter : boost::static_visitor< void >
    {
        ...
        void operator()( const db::schema::Dependency& dependency ) const { os << "    dependency " << dependency.m_id << "\n"; }
        void operator()( const db::schema::GlobalAccessor& accessor ) const { os << "   global accessor " << accessor.m_type << "\n"; }
