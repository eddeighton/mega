...
namespace Stages
{
    Interface::Interface( const boost::filesystem::path& treePath )
        :   Appending( treePath, IndexedObject::MASTER_FILE )
    {
    ...
    using ActionOverrideMap = 
        std::map< interface::Context*, concrete::Action*, Interface::CompareNodeIdentity< interface::Context > >;
    using DimensionOverrideMap = 
        std::map< interface::Dimension*, concrete::Dimension*, Interface::CompareNodeIdentity< interface::Dimension > >;
