...
#include "map/visibility.hpp"
#include "map/svgUtils.hpp"
...
namespace
{
    void renderFloorFace( map::Arrangement& arr, map::Arrangement::Face_const_handle hFace )
    {
    ...
    class ArrObserver : public CGAL::Arr_observer< map::Arrangement >
    {
    public:
        ArrObserver( map::Arrangement& arr )
        :     CGAL::Arr_observer< map::Arrangement >( arr )
        {
        }

        virtual void after_split_face(
            map::Arrangement::Face_handle f,
            map::Arrangement::Face_handle new_f, bool is_hole )
        {
...
//    }
//
//    ::map::Segment getBisector( VertexHandle v1, VertexHandle v2)
//    {
//        ::map::Segment result( v1->point(), v2->point() );
//        return result;
//    }
//};
