...
void svgLine( const map::SVGStyle& style, exact::Arrangement::Halfedge_const_handle h, double minX, double minY,
        ...
        for( exact::Arrangement::Halfedge_const_handle h : edges )
        {
...

            {
                ...
                std::ostringstream osText;
                {
                    ...
                    /*if( const map::Area* pArea = (const map::Area*)pData )
                    {
                    ...
                    if( const map::Area* pArea = (const map::Area*)pTwinData )
                    {
