...
inline ParseResult parse( const std::string& strInput, Identifier& code, std::ostream& errorStream )
{
...
// clang-format off
BOOST_FUSION_ADAPT_STRUCT( dbcomp::Type,
    ( dbcomp::IdentifierList, m_idList )
    ( std::vector< dbcomp::Type >, m_children ) )
// clang-format on
...
inline std::ostream& operator<<( std::ostream& os, const Stage& stage )
{
    ...
    struct FileVariantPrinter : boost::static_visitor< void >
    {
        ...
        void operator()( const PerObjectFile& file ) const { os << "    object " << file << "\n"; }
        void operator()( const PerProgramFile& file ) const { os << "    program " << file << "\n"; }
    };
...
// clang-format off
BOOST_FUSION_ADAPT_STRUCT( dbcomp::Stage,
    ( dbcomp::Identifier, m_name )
    ( std::vector< dbcomp::FileVariant >, m_files ) )
// clang-format on
...
public:
        ...
        : StageGrammar::base_type( m_main_rule, "Stage" )
    {
        ...
        m_main_rule
            = string( "stage" ) >> m_grammar_id[ at_c< 0 >( _val ) = qi::_1 ] >> lit( '{' ) >> *(
                  ( m_perObjectFile | m_perProgramFile )[ push_back( at_c< 1 >( _val ), qi::_1 ) ] )
              >> lit( '}' );
    }

    boost::spirit::qi::rule< Iterator, SkipGrammar< Iterator >, PerObjectFile() >  m_perObjectFile;
    boost::spirit::qi::rule< Iterator, SkipGrammar< Iterator >, PerProgramFile() > m_perProgramFile;
...
// clang-format off
BOOST_FUSION_ADAPT_STRUCT( dbcomp::Property,
    ( dbcomp::Type, m_type )
    ( dbcomp::Identifier, m_name )
    ( std::optional< dbcomp::Identifier >, m_optFile ) )
// clang-format on
...
// clang-format off
BOOST_FUSION_ADAPT_STRUCT( dbcomp::Object,
    ( dbcomp::Identifier, m_name )
    ( dbcomp::Identifier, m_file )
    ( std::vector< dbcomp::Property >, m_properties ) )
// clang-format on
...
inline ParseResult parse( const std::string& strInput, Object& object, std::ostream& errorStream )
{
...
// clang-format off
BOOST_FUSION_ADAPT_STRUCT( dbcomp::Namespace,
    ( dbcomp::Identifier, m_name )
    ( std::vector< dbcomp::NamespaceVariant >, m_elements ) )
// clang-format on
...
// clang-format off
BOOST_FUSION_ADAPT_STRUCT( dbcomp::Schema,
    ( std::vector< dbcomp::SchemaVariant >, m_elements )  )
// clang-format on
...
inline ParseResult parse( const std::string& strInput, Schema& schema, std::ostream& errorStream )
{
