...
std::vector< FinalStage::Concrete::Interupt* > JITDatabase::getInterupts() const
{
    return getPerCompilationFileType< FinalStage::Concrete::Interupt >( m_manifest, m_database );
}
