...
////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////
MissionToolbox::MissionToolbox(QWidget *parent) 
    :   QToolBox(parent)
{
}

void MissionToolbox::setToolbox( Toolbox::Ptr pToolbox )
{
    while( count() )
        removeItem( 0 );
...
MissionToolbox::ToolboxPanel::ToolboxPanel( MissionToolbox& toolbox, 
