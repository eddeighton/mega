...
{
public:
    Selection_Rect( GlyphView& view, Selection::Mode mode, float fZoomLevel, const QPointF& downPos, const QColor& colour = QColor( 0, 0, 200, 50 ) );
    ~Selection_Rect();
...
{
public:
    Selection_Path( GlyphView& view, Selection::Mode mode, float fZoomLevel, const QPointF& downPos, const QColor& colour = QColor( 0, 0, 200, 50 ) );
    ~Selection_Path();
    void update( const QPointF& pos );
