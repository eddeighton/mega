...
public:
    ...
    virtual TimeStamp SimLockReadMPO( const MPO& requestingMPO, const MPO& targetMPO,
                                      boost::asio::yield_context& yield_ctx ) override;
    virtual TimeStamp SimLockWriteMPO( const MPO& requestingMPO, const MPO& targetMPO,
                                       boost::asio::yield_context& yield_ctx ) override;
