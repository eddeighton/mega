...
mega::TimeStamp ::Clock::cycle() { return mega::MPOContext::get()->cycle(); }
mega::F32 ::Clock::ct() { return mega::MPOContext::get()->ct(); }
mega::F32 ::Clock::dt() { return mega::MPOContext::get()->dt(); }
