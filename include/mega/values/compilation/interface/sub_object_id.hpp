...
public:
    ...
    constexpr inline explicit SubObjectID( c_interface_sub_object_id _value )
        : c_interface_sub_object_id( _value )
    {
    }
...
{
    return os << "0x" << std::hex << std::setw( 4 ) << std::setfill( '0' ) << value.getValue() << "_ISO";
}
