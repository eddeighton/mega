...
{
    Reason                                                 reason;
    std::vector< runtime::Pointer >                        events;
    ...
    ReturnReason( Reason _reason, const runtime::Pointer& event )
        : reason( _reason )
        , events( 1, event )
    {
    }

    ReturnReason( Reason _reason, std::initializer_list< runtime::Pointer > _events )
        : reason( _reason )
        , events( _events )
    {
    }
