...
public:
    ...
    virtual void           load( ASTSerialiser& serialiser, io::Loader& loader ) = 0;
    virtual void           store( ASTSerialiser& serialiser, io::Storer& storer ) const = 0;
};
...
public:
    void load( io::Loader& loader, const ASTElement*& pElement );
    void store( io::Storer& storer, const ASTElement* pElement );

    template < class TDerived >
    inline void load( io::Loader& loader, TDerived*& pDerived )
    {
...
protected:
    virtual void load( ASTSerialiser& serialiser, io::Loader& loader );
    virtual void store( ASTSerialiser& serialiser, io::Storer& storer ) const;
