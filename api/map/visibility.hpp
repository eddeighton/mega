...
FloorAnalysis( Compilation& compilation, boost::shared_ptr< Schematic > pSchematic );
...
{
Analysis();
Analysis( boost::shared_ptr< Schematic > pSchematic );
public:
using Ptr = std::shared_ptr< Analysis >;

static Ptr constructFrommission( boost::shared_ptr< Schematic > pSchematic );
