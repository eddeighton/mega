...
#ifndef SHIP_30_JAN_2021
#define SHIP_30_JAN_2021
...
//////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
class Ship : public Schematic, public boost::enable_shared_from_this< Ship >
{
public:
    using Ptr    = boost::shared_ptr< Ship >;
    using PtrCst = boost::shared_ptr< const Ship >;

    static const std::string& TypeName();

    Ship( const std::string& strName );
    Ship( PtrCst pOriginal, Node::Ptr pParent, const std::string& strName );
