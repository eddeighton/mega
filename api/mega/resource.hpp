...
namespace mega
{
    ...
    class TextResource : public mega::Resource
    {
    ...
    class TextResourceHandler : public mega::ResourceHandler
    {
    protected:
        virtual mega::Resource::Ptr reload( const mega::ResourcePath& path );
    };
...
{
private:
    static const mega::Resource::Ptr get_resource( const mega::ResourcePath& resourcePath );
    static void set_resource_handler( const mega::ResourcePath& resourcePath, mega::ResourceHandler::Ptr pHandler );
    
public:
    template< typename TResourceHandlerType >
    static void set( const mega::ResourcePath& resourcePath )
    {
        set_resource_handler( resourcePath, std::make_shared< TResourceHandlerType >() );
    }

    template< typename ResourceType >
    static std::shared_ptr< ResourceType > get( const mega::ResourcePath& resourcePath )
    {
