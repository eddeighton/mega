...
// U8 = unsigned_char;
void new_unsigned_char( void* p ) { new_< unsigned char >( p ); }
...
// I8 = signed char;
void new_signed_char( void* p ) { new_< signed char >( p ); }
...
// U16 = unsigned short;
void new_unsigned_short( void* p ) { new_< unsigned short >( p ); }
...
// I16 = signed short;
void new_signed_short( void* p ) { new_< signed short >( p ); }
...
// U32 = unsigned int;
void new_unsigned_int( void* p ) { new_< unsigned int >( p ); }
...
// I32 = signed int;
void new_signed_int( void* p ) { new_< signed int >( p ); }
...
void new_int( void* p ) { new_< int >( p ); }
...
void new_unsigned_long_int( void* p ) { new_< unsigned long int >( p ); }
...
// I64 = signed long int;
void new_signed_long_int( void* p ) { new_< signed long int >( p ); }
...
// F32 = float;
void new_float( void* p ) { new_< float >( p ); }
...
// F64 = double;
void new_double( void* p ) { new_< double >( p ); }
...
void new_mega00Bitmask32Allocator344( void* p ) { new_< mega::Bitmask32Allocator< 4 > >( p ); }
void delete_mega00Bitmask32Allocator344( void* p ) { delete_< mega::Bitmask32Allocator< 4 > >( p ); }
void store_mega00Bitmask32Allocator344( void* p, void* pArchive ) { store_< mega::Bitmask32Allocator< 4 > >( p, pArchive ); }
void load_mega00Bitmask32Allocator344( void* p, void* pArchive ) { load_< mega::Bitmask32Allocator< 4 > >( p, pArchive ); }
void copy_mega00Bitmask32Allocator344( void* pFrom, void* pTo ) { copy_< mega::Bitmask32Allocator< 4 > >( pFrom, pTo ); }

// mega::reference
void new_mega00reference( void* p ) { new_< mega::reference >( p ); }
...
// mega::reference
void new_classstd00vector3int4( void* p ) { new_< std::vector<int> >( p ); }
